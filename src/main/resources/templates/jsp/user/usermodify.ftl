        ...
        <form id="userForm" name="userForm" method="post" action="/user/modify">
            ...
            <input type="hidden" name="uid" value="${user.id }"/>
			 ...
			 <div>
                    ...
                    <input type="text" Class="Wdate" id="birthday" name="birthday" value="<fmt:formatDate pattern='yyyy-MM-dd' value='${user.birthday }'></fmt:formatDate>" readonly="readonly" onclick="WdatePicker();">
                    <font color="red"></font>
              </div>
